...
#define MAX_FILE_SIZE 512
  ...
  // Step 1: Read message and signature files
  ...
  // Step 2: Create a new digest context
  EVP_MD_CTX *ctx = EVP_MD_CTX_new();
  if (!ctx) {
    return -1;
  }

  // Step 3: Initialize, update, and verify
  ...
  // EVP_DigestVerifyFinal returns 1 for success, 0 for failure
  return result;
}
